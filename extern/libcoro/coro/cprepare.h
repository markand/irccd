...
struct cprepare_coro {
	 ...
	 * ::cprepare_coro::finalizer and user is encouraged to use it
	 * instead.
	 */
	struct coro coro;
 ...
 *
 * Do not call this function within a ::cprepare_coro::finalizer callback.
 */
void
